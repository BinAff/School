CREATE TABLE [Student].[Student] (
    ...
    CONSTRAINT [FK_Student_Section] FOREIGN KEY ([SectionId]) REFERENCES [School].[Section] ([Id]),
    CONSTRAINT [FK_Student_Standard] FOREIGN KEY ([StandardId]) REFERENCES [School].[Standard] ([Id])
);
