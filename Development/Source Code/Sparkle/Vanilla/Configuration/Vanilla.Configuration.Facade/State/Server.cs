...
using CrysComp = Crystal.Configuration.Component.State;
    ...
    public class Server : BinAff.Facade.Library.Server
    {
        ...
        public override void LoadForm()
        {
            ...
            if (!this.IsError)
            {
                ...
                formDto.DtoList = dataList.Value.ConvertAll<Dto>((p) =>
                {
                    return this.Convert(p) as Dto;
                });
                formDto.CountryList = new Country.Server(null).ReadAll<Country.Dto>();
            }
        }
        ...
        public override BinAff.Facade.Library.Dto Convert(Data data)
        {
            ...
            return new Dto
            {
                Id = value.Id,
                Name = value.Name,
                Country = new Country.Server(null).Convert(value.Country) as Country.Dto,
            };
        }
        ...
        public override Data Convert(BinAff.Facade.Library.Dto dto)
        {
            ...
            return new CrysComp.Data
            {
                Id = value.Id,
                Name = value.Name,
                Country = new Country.Server(null).Convert(value.Country) as Crystal.Configuration.Component.Country.Data,
            };
        }
